...
class PpucNodeForm extends NodeForm {
    ...
    return [
      ...
      'ppuc_ini_runtime' => [
        ...
        'fields' => [
          ...
          'field_ini_debug_sound_commands',
          'field_ini_debug_audio',
          'field_ini_debug_segments',
          'field_ini_runtime_rules',
          'field_ini_alt_color',
          'field_ini_serum_timeout',
          'field_ini_serum_resolution',
          'field_ini_serum_skip_frames',
          'field_ini_pup',
          'field_ini_alt_sound',
          'field_ini_altsound_mode',
          'field_ini_b2s',
          'field_ini_b2s_angle',
          'field_ini_b2s_glow',
          ...
          'field_ini_firmware_path',
          'field_ini_allow_fw_update',
          'field_ini_allow_dev_fw_update',
          'field_ini_allow_fw_downgrade',
          'field_ini_allow_unvalidated_fw',
  ...
  protected function ppucIniFieldDescriptions(): array {
    return [
      ...
      'field_ini_no_display' => $this->t('Run without any DMD or display output.'),
      ...
      'field_ini_debug_sound_commands' => $this->t('Log the sound commands the game emits, which is how AltSound and PUP triggers are traced.'),
      'field_ini_debug_audio' => $this->t('Enable audio mixer and output debug messages.'),
      'field_ini_debug_segments' => $this->t('Enable alphanumeric segment display debug output.'),
      ...
      'field_ini_serum_resolution' => $this->t('Requested Serum output height in pixels: 0 lets the colorization decide, otherwise 32 or 64.'),
      ...
      'field_ini_altsound_mode' => $this->t('AltSound playback mode passed to the plugin. 0 keeps the mode the sound pack itself specifies.'),
      ...
      'field_ini_firmware_path' => $this->t('Directory holding board firmware images, named &lt;board type&gt;-&lt;version&gt;[+&lt;build id&gt;].uf2.'),
      'field_ini_allow_fw_update' => $this->t('Permit flashing boards whose firmware is older than the image in the firmware path.'),
      'field_ini_allow_dev_fw_update' => $this->t('Also update a board whose firmware matches by version but was built from a different commit.'),
      'field_ini_allow_fw_downgrade' => $this->t('Also flash a board whose firmware is newer than the image, to go back a version.'),
      'field_ini_allow_unvalidated_fw' => $this->t('Flash firmware that has not been validated. Leave off unless you are developing firmware.'),
