...
class __TwigTemplate_d85bd817f1ab98918c0c03daaff87aaa extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["title"] ?? null)) {
            // line 19
            echo "  <h1";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["title_attributes"] ?? null), 19, $this->source), "html", null, true);
            echo ">";
...
";
    ...
    {
        return new Source("", "core/modules/system/templates/page-title.html.twig", "/var/www/html/web/core/modules/system/templates/page-title.html.twig");
    }
